...
Keep credentials and session tokens out of the artifact. If coverage sync is
`pending`, retry `workflow(action="sync_coverage", candidate_id="...")`
before `confirm_finding`.
